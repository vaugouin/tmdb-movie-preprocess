...
) ENGINE=InnoDB AUTO_INCREMENT=36604 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `T_WC_TMDB_COMPANY_IMAGE` (
  ...
  KEY `VOTE_AVERAGE` (`VOTE_AVERAGE`),
  KEY `VOTE_COUNT` (`VOTE_COUNT`)
) ENGINE=InnoDB AUTO_INCREMENT=27761 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `T_WC_TMDB_EPISODE_LANG` (
  ...
  KEY `DAT_CREAT` (`DAT_CREAT`),
  KEY `TITLE` (`TITLE`)
) ENGINE=InnoDB AUTO_INCREMENT=1612537 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `T_WC_TMDB_MOVIE_COMPANY` (
  ...
  KEY `TIM_UPDATED` (`TIM_UPDATED`),
  KEY `DAT_CREAT` (`DAT_CREAT`)
) ENGINE=InnoDB AUTO_INCREMENT=1094313 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `T_WC_TMDB_MOVIE_GENRE` (
  ...
  KEY `TIM_UPDATED` (`TIM_UPDATED`),
  KEY `DAT_CREAT` (`DAT_CREAT`)
) ENGINE=InnoDB AUTO_INCREMENT=1477217 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `T_WC_TMDB_MOVIE_IMAGE` (
  ...
  KEY `VOTE_AVERAGE` (`VOTE_AVERAGE`),
  KEY `VOTE_COUNT` (`VOTE_COUNT`)
) ENGINE=InnoDB AUTO_INCREMENT=5137443 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `T_WC_TMDB_MOVIE_KEYWORD` (
  ...
  KEY `TIM_UPDATED` (`TIM_UPDATED`),
  KEY `DAT_CREAT` (`DAT_CREAT`)
) ENGINE=InnoDB AUTO_INCREMENT=1539353 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `T_WC_TMDB_MOVIE_LANG` (
  ...
  KEY `POSTER_PATH` (`POSTER_PATH`),
  KEY `BACKDROP_PATH` (`BACKDROP_PATH`)
) ENGINE=InnoDB AUTO_INCREMENT=1404962 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `T_WC_TMDB_MOVIE_PRODUCTION_COUNTRY` (
  ...
  KEY `TIM_UPDATED` (`TIM_UPDATED`),
  KEY `DAT_CREAT` (`DAT_CREAT`)
) ENGINE=InnoDB AUTO_INCREMENT=942370 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `T_WC_TMDB_MOVIE_SPOKEN_LANGUAGE` (
  ...
  KEY `TIM_UPDATED` (`TIM_UPDATED`),
  KEY `DAT_CREAT` (`DAT_CREAT`)
) ENGINE=InnoDB AUTO_INCREMENT=981267 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `T_WC_TMDB_MOVIE_VIDEO` (
  ...
  KEY `OFFICIAL` (`OFFICIAL`)
) ENGINE=InnoDB AUTO_INCREMENT=334501 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1139583 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `T_WC_TMDB_PERSON_IMAGE` (
  ...
  KEY `VOTE_AVERAGE` (`VOTE_AVERAGE`),
  KEY `VOTE_COUNT` (`VOTE_COUNT`)
) ENGINE=InnoDB AUTO_INCREMENT=845981 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `T_WC_TMDB_PERSON_MOVIE` (
  ...
  KEY `CREW_DEPARTMENT` (`CREW_DEPARTMENT`),
  KEY `CREW_JOB` (`CREW_JOB`)
) ENGINE=InnoDB AUTO_INCREMENT=21027239 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `T_WC_TMDB_PERSON_SEARCH` (
  ...
  KEY `DAT_CREAT` (`DAT_CREAT`),
  KEY `NAME` (`NAME`)
) ENGINE=InnoDB AUTO_INCREMENT=3637 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1270327 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `T_WC_TMDB_PERSON_SERIE` (
  ...
  KEY `CREW_DEPARTMENT` (`CREW_DEPARTMENT`),
  KEY `CREW_JOB` (`CREW_JOB`)
) ENGINE=InnoDB AUTO_INCREMENT=6961735 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `T_WC_TMDB_SERIE_GENRE` (
  ...
  KEY `TIM_UPDATED` (`TIM_UPDATED`),
  KEY `DAT_CREAT` (`DAT_CREAT`)
) ENGINE=InnoDB AUTO_INCREMENT=225276 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `T_WC_TMDB_SERIE_IMAGE` (
  ...
  KEY `VOTE_AVERAGE` (`VOTE_AVERAGE`),
  KEY `VOTE_COUNT` (`VOTE_COUNT`)
) ENGINE=InnoDB AUTO_INCREMENT=1273600 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `T_WC_TMDB_SERIE_KEYWORD` (
  ...
  KEY `TIM_UPDATED` (`TIM_UPDATED`),
  KEY `DAT_CREAT` (`DAT_CREAT`)
) ENGINE=InnoDB AUTO_INCREMENT=268852 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `T_WC_TMDB_SERIE_LANG` (
  ...
  KEY `POSTER_PATH` (`POSTER_PATH`),
  KEY `BACKDROP_PATH` (`BACKDROP_PATH`)
) ENGINE=InnoDB AUTO_INCREMENT=232684 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `T_WC_TMDB_SERIE_PRODUCTION_COUNTRY` (
  ...
  KEY `TIM_UPDATED` (`TIM_UPDATED`),
  KEY `DAT_CREAT` (`DAT_CREAT`)
) ENGINE=InnoDB AUTO_INCREMENT=127503 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
